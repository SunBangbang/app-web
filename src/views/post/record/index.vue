<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column prop="uid" label="玩家ID" width="100px"/>
      <el-table-column prop="weaponId" label="下注位置" width="100px"/>
      <el-table-column prop="weaponName" label="武器名称">
        <template slot-scope="scope">
          <el-tag :type="scope.row.monsterId> 0 ? '' : 'danger'">{{ scope.row.weaponName }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="monsterId" label="开奖怪物" width="100px"/>
      <el-table-column prop="monsterName" label="怪物名称"/> <el-table-column label="游戏类型" align="center">
        <template slot-scope="scope">
...
import { del } from '@/api/game/flowRecord'
