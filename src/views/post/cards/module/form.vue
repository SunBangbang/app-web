  ...
  <el-dialog :append-to-body="true" :visible.sync="dialog" :title="isAdd ? '新增' : '编辑'" width="500px">
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
      ...
      <el-form-item label="银行" >
        <el-input v-model="form.cardBank" style="width: 370px;"/>
      </el-form-item>
      <el-form-item label="类型" >
        <el-input v-model="form.cardType" style="width: 370px;"/>
      </el-form-item>
...
<script>
import { add, edit } from '@/api/game/cards'
export default {
  props: {
    isAdd: {
      type: Boolean,
