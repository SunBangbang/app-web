<template>
  <el-dialog :append-to-body="true" :visible.sync="dialog" :title="'修改资金密码'" width="700px">
...
<script>
import { accountPassword } from '@/api/game/account'
export default {
  props: {
    isAdd: {
      type: Boolean,
  ...
  methods: {
    ...
    doEdit() {
      accountPassword(this.form).then(res => {
        this.resetForm()
        this.$notify({
          title: '成功',
          type: 'success',
